    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            if(chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION)
            {
                ...
                System.out.println("Address: " + data1);
                System.out.println(" ");

                //have it skip the null in the text file
                ...
                while (myReader.hasNextLine()) {
                    ...
                    double yy = Double.parseDouble(parts[2]);
                    double total = xx * yy;
                    amount += total;
                ...
                System.out.println("===========================================================================================");
                System.out.println(" ");
                System.out.println("Amount Due: $" + df.format(amount));
                myReader.close();
                System.out.println("\n\nData file read!");
            }
        }
